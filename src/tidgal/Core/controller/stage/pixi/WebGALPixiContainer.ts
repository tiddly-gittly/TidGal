...
import { getOrCreateShockwaveFilterImpl, getShockwaveFilter, setShockwaveFilter } from 'src/tidgal/Core/controller/stage/pixi/filters/ShockwaveFilter';
import { getOrCreateRadiusAlphaFilterImpl, getRadiusAlphaFilter, setRadiusAlphaFilter } from 'src/tidgal/Core/controller/stage/pixi/shaders/RadiusAlphaFilter';
...
export class WebGALPixiContainer extends PIXI.Container {
  ...
  private readonly alphaFilter = new PIXI.filters.AlphaFilter(1);
