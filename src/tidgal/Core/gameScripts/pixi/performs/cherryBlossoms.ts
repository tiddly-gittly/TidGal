...
import { registerPerform } from 'src/tidgal/Core/util/pixiPerformManager/pixiPerformManager';
...
const pixicherryBlossoms = (cherryBlossomsSpeed: number) => {
  ...
  WebGAL.gameplay.pixiStage!.registerAnimation(
    { setStartState: () => {}, setEndState: () => {}, tickerFunc: tickerFunction },
